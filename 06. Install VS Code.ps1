# Downloading the VS Code installation script from the PS Gallery
$VscPath = 'C:\Foo'
$RV      = "2.8.5.208"
...
# Reviewing the installation help details
...
$SAMPLE = 'https://raw.githubusercontent.com/doctordns/PACKT-PS7/master/scripts/goodies/Microsoft.VSCode_profile.ps1'
(Invoke-WebRequest -Uri $Sample).Content | Out-File $Profile
...
$JHT | ConvertTo-Json  | Out-File -FilePath $Settings
...
$URI2 = 'https://raw.githubusercontent.com/doctordns/PacktPS72/main/' + "Scripts/Goodies//$ProfileFile2"
(Invoke-WebRequest -Uri $URI2).Content | Out-File -FilePath  $ConsoleProfile
