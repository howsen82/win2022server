...
Get-ADRootDSE -Server SVR.Reskit.Org
...
Get-ADUser -Filter * | Sort-Object -Property Name | Format-Table -Property Name, DistinguishedName

# 6. Getting initial AD groups
Get-ADGroup -Filter * | Sort-Object -Property GroupScope, Name | Format-Table -Property Name, GroupScope

# 7. Examining Enterprise Admins group membership
Get-ADGroupMember -Identity 'Enterprise Admins'

# 8. Checking DNS zones on DC1
Get-DnsServerZone -ComputerName SVR
