...
Resolve-DnsName -Name SVR.Reskit.Org -Type A

# 3. Checking network connection to DC1
Test-NetConnection -ComputerName SVR.Reskit.Org -Port 445
Test-NetConnection -ComputerName SVR.Reskit.Org -Port 389
...
Get-ADUser -Filter * -Server DC1.Reskit.Org | Format-Table -Property SamAccountName, DistinguishedName
