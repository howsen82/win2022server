...
$Users = Import-CSV -Path C:\Foo\Users.csv | Sort-Object -Property Alias
$Users | Format-Table
...
Get-ADUser -Filter * -Property Description | Format-Table -Property Name, UserPrincipalName, Description
