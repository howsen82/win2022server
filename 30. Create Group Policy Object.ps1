# Template
# Windows 10 - https://www.microsoft.com/en-us/download/details.aspx?id=104678
#              https://www.microsoft.com/en-us/download/details.aspx?id=104677 (.Admx)
# Windows 11 - https://www.microsoft.com/en-us/download/details.aspx?id=104594
#              https://www.microsoft.com/en-us/download/104593 (.Admx)
# Windows 8.1 - https://www.microsoft.com/en-us/download/43413 (.Admx)
# Windows Server 2022 - https://www.microsoft.com/en-us/download/details.aspx?id=104005
#              https://www.microsoft.com/en-us/download/details.aspx?id=104003 (.Admx)
# All Links - https://learn.microsoft.com/en-us/troubleshoot/windows-client/group-policy/create-and-manage-central-store
...
Get-GPO -All -Domain Reskit.Org | Sort-Object -Property DisplayName | Format-Table -Property Displayname, Description, GpoStatus
...
$FMTS -f '----','---------', '-------', '-----------'
$XML.report.GPO | Sort-Object -Property Name | ForEach-Object {
    $Gname = $_.Name
...
Get-GPO -Domain 'Reskit.Org' -All | Format-Table -Property DisplayName, GPOStatus, Description