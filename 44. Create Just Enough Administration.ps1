...
New-Item -Path $Capabilities -ItemType Directory | Out-Null
...
New-ADGroup @DNSGHT
Get-ADGroup -Identity 'DNSAdminsJEA' | Move-ADObject -TargetPath 'OU=IT, DC=Reskit, DC=Org'
...
$RDHT = @{
    'DnsAdminsJEA' = @{ 'RoleCapabilityFiles' = 'C:\JEACapabilities\DnsAdmins.psrc' }
}
$PSCHT= @{
...
Get-PSSessionCapability @SCHT | Sort-Object -Property Module
