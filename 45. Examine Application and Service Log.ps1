...
$LogsDC1 = Invoke-Command -ComputerName SVR -ScriptBlock $SB1
"There are $($LogsDC1.Count) total event logs on SVR"
...
$Logs | Where-Object IsEnabled | Where-Object RecordCount -gt 0 | Measure-Object | Select-Object -Property Count
