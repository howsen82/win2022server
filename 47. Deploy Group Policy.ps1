...
$GPOKEY1 = 'HKCU\Software\Policies\Microsoft\PowerShellCore\ModuleLogging'
$GPOHT1 = @{
...
$GPOKey3 = 'HKCU\Software\Policies\Microsoft\PowerShellCore\ScriptBlockLogging'
$GPOHT3  = @{
    DisplayName    = $PshGPO.DisplayName
    Key            = $GPOKEY3
    Type           = [Microsoft.Win32.RegistryValueKind]::DWord
...
$GPOKey4 = 'HKCU\Software\Policies\Microsoft\PowerShellCore'
...
New-GPLink -DisplayName $PshGPO.Displayname -Target $Target | Out-Null
