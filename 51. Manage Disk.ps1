...
[int] $SRV1Controller = Get-VMScsiController -VMName SRV1 | Select-Object -Last 1 | Select-Object -ExpandProperty ControllerNumber
Add-VMScsiController -VMName SRV2 
[int] $SRV2Controller = Get-VMScsiController -VMName SRV1 | Select-Object -Last 1 | Select-Object -ExpandProperty ControllerNumber
...
$Disk2 = Get-Disk | Where-Object PartitionStyle -eq Raw | Select-Object -First 1
$Disk2 | Initialize-Disk -PartitionStyle MBR
