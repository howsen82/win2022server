...
Get-PSDrive | Where-Object Provider -match 'Registry' | ft -a
...
$HomeFolder = Get-PSProvider -PSProvider FileSystem | Select-Object -ExpandProperty Home
$HomeFolder
...
Get-ChildItem -Path Cert:\LocalMachine\Root | Format-Table FriendlyName, Thumbprint
