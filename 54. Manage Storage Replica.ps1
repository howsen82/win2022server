# Run on SRV1, with SRV2, DC1 online (Windows Server 2022 Datacenter)
...
Add-WindowsFeature -Name Storage-Replica -IncludeManagementTools | Out-Null
...
$ScriptBlock3 = {
    Get-Volume | Sort-Object -Property DriveLetter | Format-Table
}
Invoke-Command -ComputerName SRV2 -ScriptBlock $ScriptBlock3
