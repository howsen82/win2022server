...
[int] $FS1Controller = Get-VMScsiController -VMName FS1 | Select-Object -Last 1 | Select-Object -ExpandProperty ControllerNumber
...
New-Item -Path F:\Secure1 -ItemType Directory | Out-Null
...
$ScriptBlock= {
    try {
        ...
        New-ADGroup -Name Sales -GroupScope Global | Out-Null
    }
}
