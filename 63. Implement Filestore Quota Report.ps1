...
Get-FsrmStorageReport -Name * | Format-Table -Property Name, NameSpace, ReportType, ReportFormat
...
$Files | Where-Object Path -NotMatch '^Windows|^Program|^Users'| Format-Table -Property name, path,
    @{ Name ='Sizemb'
...
Get-ScheduledTask -TaskName '*Monthly*' | Start-ScheduledTask
