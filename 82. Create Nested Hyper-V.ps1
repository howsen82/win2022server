...
Get-VMProcessor -VMName PSDirect | Format-Table -Property Name, Count, ExposeVirtualizationExtensions
...
$Cred = [System.Management.Automation.PSCredential]::new($User, $SecurePW)
