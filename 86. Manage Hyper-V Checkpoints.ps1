...
$Pass        = 'Pa$$w0rd'
$RKPassword  = ConvertTo-SecureString -String $Pass -AsPlainText -Force
$RKCred = [System.Management.Automation.PSCredential]::new($RKAdmin,$RKPassword)
...
$Parent = Split-Path -Parent (Get-VM -Name PSdirect | Select-Object -ExpandProperty HardDrives).Path | Select-Object -First 1
...
Get-VMSnapshot -VMName PSDirect | Remove-VMSnapshot
