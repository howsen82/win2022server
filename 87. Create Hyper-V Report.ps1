...
$ReportHT.CPUCount = ($Proc | Where-Object elementname -match 'Logical Processor').Count

# 5. Adding the current host CPU usage
$ClassName = 'Win32_PerfFormattedData_PerfOS_Processor'
$CPU = Get-CimInstance  -ClassName $ClassName | Where-Object Name -eq '_Total' | Select-Object -ExpandProperty PercentProcessorTime
...
$VMReportDetails = $VMDetails | Sort-Object -Property VMName | Format-Table | Out-String
