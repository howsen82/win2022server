...
Find-Module -Name PSScriptAnalyzer | Format-List Name, Version, Type, Desc*, Author, Company*, *Date, *URI*
...
Get-ScriptAnalyzerRule | Group-Object -Property Severity | Sort-Object -Property Count -Descending
