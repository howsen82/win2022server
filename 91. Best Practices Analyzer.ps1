...
$BPASession = New-PSSession -ComputerName SVR

# 2. Discovering the BPA module on DC1
$ScriptBlock1 = {
    Get-Module -Name BestPractices -List | Format-Table -AutoSize
}
...
$ScriptBlock5 = {
    Get-BpaResult -ModelID Microsoft/Windows/DirectoryServices | Where-Object Resolution -ne $null| Format-List -Property Problem, Resolution
}
