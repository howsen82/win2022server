...
$ScriptBlock1 = {
    ...
    Install-WindowsFeature @InstallHT | Format-Table -AutoSize -Wrap
}
...
Invoke-Command -ComputerName SVR -ScriptBlock $ScriptBlock3
...
Invoke-Command -ComputerName SVR -ScriptBlock {
    Get-Command -Module UpdateServices | Format-Table -AutoSize
}
...
Invoke-Command -Session $Session -ScriptBlock {
    $WSUSServer.GetConfiguration() | Select-Object -Property SyncFromMicrosoftUpdate, LogFilePath
}
...
Invoke-Command -Session $Session -ScriptBlock {
    ...
    $WSUSProducts | Select-Object -ExpandProperty Product | Format-Table -Property Title, Description
}
...
Invoke-Command -Session $Session -ScriptBlock {
    ...
    $WSUSProducts | Select-Object -ExpandProperty Product -First 25 | Format-Table -Property Title, Description
}